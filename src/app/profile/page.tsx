        ...
        <Container>
          ...
          <div className="flex items-center justify-center space-y-2 mx-auto mb-4">
            <Link href="https://www.linkedin.com/in/danilokovarike/">
              <Img src={social_media.linkedin} alt="linkedin" width={100} height={100} />
            </Link>

            <Link href="https://www.github.com/kovarike/">
              <Img src={social_media.github} alt="gitub" width={100} height={100} />
            </Link>
            <Link href="https://www.instagram.com/usdanilo/">
              <Img src={social_media.whatsapp} alt="whatsapp" width={100} height={100} />
            </Link>

            <Link href="https://www.instagram.com/usdanilo/">
              <Img src={social_media.instagram} alt="intagram" width={100} height={100} />
            </Link>
            <Link href="https://www.github.com/kovarike/">
              <Img src={social_media.email} alt="email" width={100} height={100} />
            </Link>
          </div>

          <div className="mx-auto mt-2 overflow-hidden space-x-1 border-b border-slate-500">
            <div className="flex items-center justify-center">
              <Img src={profile.github} alt="github" width={300} height={100}/>
            </div>
